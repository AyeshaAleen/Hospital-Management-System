<%@ Page Title="Forms Sections Management" Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Webroot/Forms/FormMaster.master" AutoEventWireup="true" CodeBehind="ViewDocumentSection.aspx.cs"
    Inherits="Forms.Webroot.Forms.Management.ViewDocumentSection" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FormMasterBody" runat="server">
    ...
    <%--  <asp:UpdatePanel ID="sectionpanal" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            ...
            <div class="portlet">
                ...
                <div id="bg-inverse1" class="panel-collapse collapse">
                    <div class="portlet-body">
                        ...
                        <div class="clearfix"></div>
                       <asp:UpdatePanel ID="SectionUpdatePanal" runat="server">
                                <ContentTemplate>
                                <table class="table-bordered table-striped table-hover" data-toggle="table" data-search="true"
                                    data-page-list="[10, 20, 50, 100]"
                                    data-page-size="10" data-pagination="true">
                                ...
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="btnAddUserRole" EventName="Click" />
                                </Triggers>
                            </asp:UpdatePanel>
                        ...
                        <div class="col-md-6 col-md-offset-6">
                            <div class="form-group">
                                ...
                                <label class="checkbox-inline">
                                    <asp:CheckBox ID="chkStorage" Text="Storage" runat="server" /></label>
                                <label class="checkbox-inline">
                                    <asp:CheckBox ID="chkEmail" Text="Email" runat="server" /></label>
                            </div>
                        </div>
