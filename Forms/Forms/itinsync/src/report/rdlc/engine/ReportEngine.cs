using Forms.itinsync.src.report.rdlc.builder;
using System;
...
namespace Forms.itinsync.src.report.rdlc.engine
{
    public static class ReportEngine
    {
        ...
        static string GetReportData(ReportBuilder reportBuilder)
        {
            ...
            byte[] imgBinary = File.ReadAllBytes(HttpContext.Current.Server.MapPath("itinsync\\resources\\images") + "\\headline.png");
