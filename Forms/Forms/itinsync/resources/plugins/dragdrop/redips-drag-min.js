    ...
    $ = function () {
        ...
        for (h = 0; h < g.length; h++)
            if (!1 !==
                ...
                0 > j || 0 > l ? a() : j !== f && (n[0] = d[j][0], n[2] = n[0] + g[h].rows[j].cells[l].offsetHeight, (r < n[0] || r > n[2]) && a());
    ...
    A = function (a, c) {
        ...
        for (d = b = 0; b < f.length; b++)
            if (Za.test(f[b].className)) "init" ===
                a || void 0 === f[b].redips ? (f[b].redips = {}, f[b].redips.container = y) : !0 === a && "number" === typeof i ? (f[b].style.opacity = "", f[b].style.filter = "") : !1 === a && "number" === typeof i && (f[b].style.opacity = i / 100, f[b].style.filter = "alpha(opacity=" + i + ")"), W(f[b], j), f[b].style.cursor = h, f[b].redips.enabled = j;
