...
namespace Utils.itinsync.icom.constant.lookup
{
    public static  class LookupsConstant
    {
        ...
        public static readonly string LKPaymentMode = "LKPaymentMode";
        public static readonly string LKEmailType = "LKEmailType";
        public static readonly string LKAddressType = "LKAddressType";
        public static readonly string LKAuditEvent = "LKAuditEvent";

        public static readonly string LKPhoneType = "LKPhoneType";
        public static readonly string LKAgreementType = "LKAgreementType";
        public static readonly string LKVendorPaymentFrequency = "LKVendorPaymentFrequency";
        public static readonly string LKTranType = "LKTranType";
        ...
        public static readonly string LKEmailRouting = "LKEmailRouting";

        public static readonly string LKUserEmailRouting = "LKUserEmailRouting";
