...
namespace Utils.itinsync.icom.SecurityManager
{
    public  class SecurityManager
    {
        ...
        private static string SecurityStringEncode(string value, string key)
        {
        ...
        private static string SecurityStringDecode(string value, string key)
        {
            string dataValue = "";
            var mac3des = new MACTripleDES();
            var md5 = new MD5CryptoServiceProvider();
        ...
        public static string EncodeString(Int32 value)
        {
            return EncodeString(Convert.ToString(value));
        }

        public static string RandomNumber(int value)
        {
            return Utils.getRandomCode(value);
        }
        ...
        public static string DecodeString(Int32 value)
        {
            return DecodeString(Convert.ToString(value));
        }
