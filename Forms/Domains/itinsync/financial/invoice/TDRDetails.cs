...
namespace Entities.itinsync.invoice
{
    public class TDRDetails
    {
        public enum columns
        {
            tdrdetailsid, VRN, driverName, shipmentquantity, shipmentweight, cellNo, License,
            receivedquantity, receivedweight, receiverName, receiverCellNo, Shortage,
            invoiceid, remarks, transID, receiveon, sourceterminal, parentref
        }
        ...
        public Int32 receiveon { get; set; }
