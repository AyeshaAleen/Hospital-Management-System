...
namespace Domains.itinsync.icom.views.routeusers
{
    public class XDocumentRouteUsersView : System.Attribute, IDomain
    {
        ...
        [LookupAttribute(lookupName = "LKUserEmailRouting", relatedTag = "role_Text")]
